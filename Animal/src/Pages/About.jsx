    ...
    <div className='bg-gradient-to-t from-black via-primary to-black p-4 mt-24'>
      <div className='container mx-auto p-4'>
              <div className='md:text-2xl text-xl sm:text-xl text-center text-white'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-3 p-4 mt-8 mb-8 text-black'>
                      <div className='bg-white rounded-md'>
                        <h1 className=' font-bold mb-8 mt-2 text-primary'>Our Mission</h1>
                      ...
                      <div className='bg-white rounded-md '>
                        <h1 className=' font-bold mb-10 mt-2 text-primary'>Our Story</h1>
                        <p>
                      ...
                      <div className='bg-white rounded-md '>
                        <h1 className=' font-bold mb-8 mt-2 text-primary'>What We Do</h1>
                        <p>
                      ...
                      <div className='bg-white rounded-md '>
                        <h1 className='font-bold mb-10 mt-2 text-primary'>Join Us</h1>
                        <p>
